<div align="center">
    <img src="https://raw.githubusercontent.com/brillouin-imaging/brimfile/refs/heads/main//brimfile_logo.png"/>
</div>

# brimfile package

[![Documentation](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://brillouin-imaging.github.io/brimfile/brimfile.html)
...
The detailed specs of the brim file format can be found [here](https://github.com/brillouin-imaging/Brillouin-standard-file/blob/main/docs/brim_file_specs.md).
...
The full documentation of the package can be found [here](https://brillouin-imaging.github.io/brimfile/).
...
You can download the [Matlab toolbox](https://github.com/brillouin-imaging/brimfile/releases/tag/matlab_toolbox_main), which is basically a wrapper around the Python brimfile package, so you can refer to the [same documentation](https://brillouin-imaging.github.io/brimfile/). We only support Matlab >= R2023b, as brimfile needs Python 3.11.
